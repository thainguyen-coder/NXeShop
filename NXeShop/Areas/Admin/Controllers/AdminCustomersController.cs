...
namespace NXeShop.Areas.Admin.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public AdminCustomersController(EWEBBANHANGDBDBMARKETSMDFContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index(int? page)
        {
            ...
            int pageSize = 20;
            var lstCustomer = _context.Customers.AsNoTracking().Include(l => l.Location).OrderByDescending(x => x.CreateDate);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EWEBBANHANGDBDBMARKETSMDFContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
