...
namespace NXeShop.Areas.Admin.Controllers
{
    ...
    public class AdminProductsController : Controller
    {
        ...
        public AdminProductsController(EWEBBANHANGDBDBMARKETSMDFContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index(int? page, int CatId = 0)
        {
            ...
            ViewBag.CurentCatID = CatId;
            return View(models);
        }

        //Admin/AdminProducts/Fillter
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EWEBBANHANGDBDBMARKETSMDFContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
