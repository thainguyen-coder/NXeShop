...
namespace NXeShop.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(EWEBBANHANGDBDBMARKETSMDFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var eWEBBANHANGDBDBMARKETSMDFContext = _context.Accounts.Include(a => a.Role);
            return View(await eWEBBANHANGDBDBMARKETSMDFContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EWEBBANHANGDBDBMARKETSMDFContext.Accounts'  is null.");
            }
            var account = await _context.Accounts.FindAsync(id);
            if (account != null)
            {
