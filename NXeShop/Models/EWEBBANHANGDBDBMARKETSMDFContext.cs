...
{
    public partial class EWEBBANHANGDBDBMARKETSMDFContext : DbContext
    {
        public EWEBBANHANGDBDBMARKETSMDFContext()
        {
        }

        public EWEBBANHANGDBDBMARKETSMDFContext(DbContextOptions<EWEBBANHANGDBDBMARKETSMDFContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                var connectionString = configuration.GetConnectionString("dbNXeShop");
